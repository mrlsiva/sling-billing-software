                ...
                Route::group(['middleware' => ['role:HO']], function () {
                    ...
                    Route::prefix('products')->group(function () {
                        Route::name('product.')->group(function () {
                            ...
                            Route::get('/bulk_upload', fn() => redirect()->route('product.index', ['company' => request()->route('company')]))->name('bulk_upload.get');
                            Route::get('{product}/{branch}/detail',[productController::class, 'detail'])->name('detail');
                        ...
                        Route::name('vendor.')->group(function () {
                            ...
                            Route::prefix('purchase_orders')->group(function () {
                                Route::name('purchase_order.')->group(function () {
                                    ...
                                    Route::get('/get_product_stock', [purchaseOrderController::class, 'get_product_stock']);
                        ...
                        Route::name('inventory.')->group(function () {
                            ...
                            Route::prefix('stocks')->group(function () {
                                Route::name('stock')->group(function () {
                                    ...
                                    Route::get('/{shop}/{branch}/download',[inventoryController::class, 'download'])->name('.download');
                    ...
                    Route::prefix('billing')->group(function () {
                        Route::name('billing.')->group(function () {
                            ...
                            Route::get('/get_variation_detail',[billingsController::class, 'get_variation_detail'])->name('get_variation_detail');
                        ...
                        Route::name('branch.')->group(function () {
                            ...
                            Route::prefix('products')->group(function () {
                                Route::name('product.')->group(function () {
                                    ...
                                    Route::get('/download',[stockController::class, 'download'])->name('download');
