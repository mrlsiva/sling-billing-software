				    ...
				    <div class="row mb-3 p-3">
				    	<div class="col-md-11">
				    		<div class="input-group">
				    			...
				    			<span class="input-group-text" id="clearFilter" style="display: {{ request('vendor') ? 'inline-flex' : 'none' }}"><a href="{{route('vendor.purchase_order.index', ['company' => request()->route('company')])}}" class="link-dark"><i class="ri-close-large-line align-middle fs-20"></i></a></span>
				    		</div>
				    	</div>
