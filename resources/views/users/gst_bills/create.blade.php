...
@section('body')
     <div class="row">
        ...
        <div class="col-xl-12 col-md-12">
            <form class="row" action="{{route('gst_bill.store', ['company' => request()->route('company')])}}" method="post" enctype="multipart/form-data" id="productCreate">
                @csrf
                <div class="card">
                ...
                <div class="p-3 mb-3 rounded">
                    <div class="row justify-content-end g-2">
                        ...
                        <div class="col-md-2">
                            <a href="{{route('gst_bill.index', ['company' => request()->route('company'),'branch' => request()->route('branch')])}}" class="btn btn-outline-secondary w-100"><i class="ri-close-circle-line"></i> Cancel</a>
                        </div>
                    </div>
                </div>
            </form>
