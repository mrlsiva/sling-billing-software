<div class="col-xl-12 col-md-12">
	<form class="row"  id="productCreate">
		@csrf
		<div class="card">
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="mb-3 position-relative">
							...
							@php
								$categories = App\Models\Category::where([['user_id',Auth::user()->owner_id],['is_active',1]])->get();
							@endphp
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							@php
							$taxes = App\Models\Tax::where([['shop_id',Auth::user()->owner_id],['is_active',1]])->get();
							@endphp
					...
					<div class="col-md-4">
						<div class="mb-3">
							...
							@php
								$metrics = App\Models\Metric::where([['shop_id',Auth::user()->id],['is_active',1]])->get();
							@endphp
					...
					<div class="col-md-12" id="sizes-section" style="display:none;">
						...
						@php
							$sizes = App\Models\Size::where('shop_id', Auth::user()->owner_id)->where('is_active', 1)->get();
						@endphp
					...
					<div class="col-md-12" id="colours-section" style="display:none;">
						...
						@php
							$colours = App\Models\Colour::where('shop_id', Auth::user()->owner_id)->where('is_active', 1)->get();
						@endphp
		...
		<div class="p-3 mb-3 rounded">
			<div class="row justify-content-end g-2">
				<div class="col-md-3">
					<button type="submit" class="btn btn-primary w-100" id="productSubmit"><i class="ri-save-line"></i> Submit</button>
				</div>
				<!-- <div class="col-md-2">
