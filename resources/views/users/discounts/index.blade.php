        ...
        <div class="card">
            ...
            <div class="card-body pt-2 ">
                <ul class="nav nav-tabs nav-justified">
                	 ...
                	 <li class="nav-item">
                        <a href="{{route('discount.index', ['company' => request()->route('company'),'branch' => 0])}}" class="nav-link {{ request()->route('branch') == 0 ? 'active' : '' }}" id="{{Auth::user()->id}}">
                    ...
                    @foreach($branches as $branch)
                    	<li class="nav-item">
	                        <a href="{{route('discount.index', ['company' => request()->route('company'),'branch' => $branch->id])}}" class="nav-link {{ request()->route('branch') == $branch->id ? 'active' : '' }}" id="{{$branch->id}}">
	                            <span class="d-block d-sm-none"><i class="bx bx-home"></i></span>
                ...
                <div class="tab-content pt-2 text-muted">
                    <div class="tab-pane show active" id="homeTabsJustified">
                        ...
                        <form method="get" action="{{route('discount.index', ['company' => request()->route('company'),'branch' => request('branch')])}}">
                            <div class="row mb-2">
                                <div class="col-md-5">
                                    <div class="mb-2">
