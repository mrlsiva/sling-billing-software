		...
		<div class="col-xl-12">
			<div class="card">
				...
				<div class="p-3">
					...
					<form method="post" action="{{route('expense.store', ['company' => request()->route('company')])}}" class="row g-2 align-items-end mb-4">
						@csrf
						<div class="col-md-5">
					...
					<form method="get" action="{{route('expense.index', ['company' => request()->route('company')])}}" class="row g-2 mb-3">
						<div class="col-md-3">
						...
						<table class="table align-middle mb-0 table-hover table-centered">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<form method="post" action="{{ route('expense.destroy', ['company' => request()->route('company'), 'id' => $expense->id]) }}" onsubmit="return confirm('Delete this expense?');">
											@csrf
