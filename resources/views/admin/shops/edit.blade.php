                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="is_size_differentiation_available" name="is_size_differentiation_available" {{ $user->user_detail->is_size_differentiation_available == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="is_colour_differentiation_available" name="is_colour_differentiation_available" {{ $user->user_detail->is_colour_differentiation_available == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="able_to_edit_bill" name="able_to_edit_bill" {{ $user->user_detail->able_to_edit_bill == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="able_to_edit_bill">Able To Edit Bill</label>
                                        <span class="text-danger">*</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="is_gst_bill_avaiable" name="is_gst_bill_avaiable" {{ $user->user_detail->is_gst_bill_avaiable == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_gst_bill_avaiable">Is GST Bill Available</label>
                                        <span class="text-danger">*</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="able_to_login" name="able_to_login" {{ $user->able_to_login == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="able_to_login">Able to Login</label>
                                        <span class="text-danger">*</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="able_to_round_price" name="able_to_round_price" {{ $user->user_detail->able_to_round_price == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="online_paid_order_confirmation" name="online_paid_order_confirmation" {{ $user->user_detail->online_paid_order_confirmation == 1 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select id="payment_gateway" name="payment_gateway" class="form-control">
                                        <option value="" {{ !$user->user_detail->payment_gateway ? 'selected' : '' }}>None</option>
                                        <option value="razorpay" {{ $user->user_detail->payment_gateway == 'razorpay' ? 'selected' : '' }}>Razorpay</option>
                                        <option value="payu" {{ $user->user_detail->payment_gateway == 'payu' ? 'selected' : '' }}>PayU</option>
                                        <option value="stripe" {{ $user->user_detail->payment_gateway == 'stripe' ? 'selected' : '' }}>Stripe</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="payment_gateway_key_id" name="payment_gateway_key_id" class="form-control" placeholder="e.g. rzp_test_xxxxxxxx" value="{{old('payment_gateway_key_id', $user->user_detail->payment_gateway_key_id)}}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="payment_gateway_key_secret" class="form-label">Key Secret</label>
                                    <input type="password" id="payment_gateway_key_secret" name="payment_gateway_key_secret" class="form-control" placeholder="{{ $user->user_detail->payment_gateway_key_secret ? 'Leave blank to keep unchanged' : 'Enter Key Secret' }}" autocomplete="new-password">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label for="payment_gateway_webhook_secret" class="form-label">Webhook Secret</label>
                                    <input type="password" id="payment_gateway_webhook_secret" name="payment_gateway_webhook_secret" class="form-control" placeholder="{{ $user->user_detail->payment_gateway_webhook_secret ? 'Leave blank to keep unchanged' : 'Enter Webhook Secret' }}" autocomplete="new-password">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <small class="text-muted">Secrets are never shown again once saved — leave blank to keep the existing value.</small>
                            </div>
                        </div>
                    </div>
                </div>
