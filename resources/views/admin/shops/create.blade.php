                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="bill_type" id="bill_type" required="">
                                        ...
                                        <option value="{{$printer_type->id}}">{{$printer_type->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="is_bill_enabled" name="is_bill_enabled" checked="">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="is_colour_differentiation_available" name="is_colour_differentiation_available">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="able_to_edit_bill" name="able_to_edit_bill">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="is_imei_required" name="is_imei_required">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="is_gst_bill_avaiable" name="is_gst_bill_avaiable">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="able_to_login" name="able_to_login">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <div class="form-check form-switch mt-5">
                                        <input class="form-check-input" type="checkbox" id="able_to_delete_order" name="able_to_delete_order">
