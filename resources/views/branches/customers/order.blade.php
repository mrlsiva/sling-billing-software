                    ...
                    <div class="row mb-2 p-3">
                        <div class="col-md-11">
                            <div class="input-group">
                                ...
                                <span class="input-group-text"><a href="{{route('branch.customer.order', ['company' => request()->route('company'),'id' => request()->route('id')])}}" class="link-dark"><i class="ri-close-large-line align-middle fs-20"></i></a></span>
                            </div>
                        </div>
