				    ...
				    <div class="row mb-3 p-3">
				    	<div class="col-md-6">
				    		<div class="input-group">
				    			...
				    			<span class="input-group-text" id="clearFilter" style="display: {{ request('product') ? 'inline-flex' : 'none' }}"><a href="{{route('branch.stock_transfer.transfer', ['company' => request()->route('company')])}}" class="link-dark"><i class="ri-close-large-line align-middle fs-20"></i></a></span>
				    		</div>
				    	</div>
				    	<div class="col-md-5">
				    		@php
						...
						<table class="table align-middle mb-0 table-hover table-centered">
							...
							<tbody>
									...
									<tr>
										...
										<td>
											<a href="{{ route('branch.stock_transfer.get_bill', ['company' => request()->route('company'),'id' => $transfer->id ]) }}" class="link-dark" target="_blank"><i class="ri-printer-line align-middle fs-20" title="Print Bill"></i></a>
										</td>
									</tr>
									@endforeach
							</tbody>
