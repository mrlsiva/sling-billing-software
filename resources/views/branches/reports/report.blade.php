				    ...
				    <div class="col-xl-3 col-md-6">
				        <div class="card border shadow-sm">
				            <div class="card-body text-center">
				                ...
				                <a href="{{route('branch.report.order', ['company' => request()->route('company')])}}" class="btn btn-primary btn-sm">View Report</a>
				            </div>
				        </div>
				    </div>
				    ...
				    <div class="col-xl-3 col-md-6">
				        <div class="card border shadow-sm">
				            <div class="card-body text-center">
				                ...
				                <a href="{{route('branch.report.daily', ['company' => request()->route('company')])}}" class="btn btn-danger btn-sm">View Report</a>
				            </div>
				        </div>
				    </div>
				    ...
				    <div class="col-xl-3 col-md-6">
				        <div class="card border shadow-sm">
				            <div class="card-body text-center">
				                ...
				                <a href="{{route('branch.report.transfer', ['company' => request()->route('company'),'branch' => 0])}}" class="btn btn-success btn-sm">View Report</a>
				            </div>
				        </div>
				    </div>
				    ...
				    <div class="col-xl-3 col-md-6">
				        <div class="card border shadow-sm">
				            <div class="card-body text-center">
				                ...
				                <a href="{{route('branch.report.sales', ['company' => request()->route('company'),'branch' => 0])}}" class="btn btn-warning btn-sm">View Report</a>
				            </div>
				        </div>
				    </div>
