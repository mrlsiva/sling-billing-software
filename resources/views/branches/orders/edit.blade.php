                                ...
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-7">
                                                @if($order->status != 0 && $order->status != 5)
                                                <select class="form-control" name="order_status" id="order_status" data-order-id="{{ $order->id }}">
                        ...
                        @if($order->status == 0)
                            <div class="col-md-12">
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        <form method="post" id="orderUpdateForm" action="{{ route('branch.order.online.update', ['company' => request()->route('company'),'id' => $order->id]) }}"enctype="multipart/form-data">
                                        @csrf
                                        <div class="row g-2">
                                            <div class="col-md-12">
                                                <div class="mb-3">
...
$(document).on('change', '.product-status', function () {
    ...
    $.ajax({
        url: "{{ route('branch.order.online.detail.status.update', ['company' =>  request()->route('company')]) }}",
        type: "POST",
        data: {
...
$("#order_status").on("change", function () {
    ...
    $.ajax({
        url: "{{ route('branch.order.online.status.update', ['company' =>  request()->route('company')]) }}",
